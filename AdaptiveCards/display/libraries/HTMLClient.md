...
### HostConfig 
To customize the renderer, provide an instance of the HostConfig object. See [Host Config](../HostConfig.md) for the full description. When you register it, you are setting the global host config for all rendering actions you perform with the library.
