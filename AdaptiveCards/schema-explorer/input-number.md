---
title:  Input.Number Action
author: luywang
description: This page provides documentation for the `Input.Number` input in the Adaptive Cards schema.
ms.author: luywang
ms.date: 12/11/2025
...
### Example 1: Input.Number with Min, Max, and Value

| JSON | Adaptive Card |
| :--- | :--- |
| ` json {	"$schema": "http://adaptivecards.io/schemas/adaptive-card.json",	"type": "AdaptiveCard",	"version": "1.3",	"body": [		{			"type": "Input.Number",			"id": "number",			"placeholder": "Enter a number",			"label": "Enter a number",			"min": 1,			"max": 10,			"value": 3		}	],	"actions": [		{			"type": "Action.Submit",			"title": "OK"		}	] }  ` | [Adaptive Card Try it Yourself \>] |
