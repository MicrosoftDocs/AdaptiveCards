---
title:  Action.OpenUrl Action
author: luywang
description: This page provides documentation for the `Action.OpenUrl` action in the Adaptive Cards schema.
ms.author: luywang
ms.date: 12/11/2025
...
This page documents the **Action.OpenUrl** action, which, when invoked, will show the given URL either by launching it in an external web browser or by showing it within an embedded web browser.
...
### Basic Action.OpenUrl Example (JSON)
