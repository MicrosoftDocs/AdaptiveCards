---
title:  Input.Date Action
author: luywang
description: This page provides documentation for the `Input.Date` input in the Adaptive Cards schema.
ms.author: luywang
ms.date: 12/11/2025
...
| JSON | Adaptive Card |
| :--- | :--- |
| ` json {	"$schema": "http://adaptivecards.io/schemas/adaptive-card.json",	"type": "AdaptiveCard",	"version": "1.0",	"body": [		{			"type": "TextBlock",			"text": "Date Input"		},		{			"type": "Input.Date",			"id": "date",			"placeholder": "Enter a date",			"value": "2017-10-12"		}	],	"actions": [		{			"type": "Action.Submit",			"title": "OK"		}	] }  ` | [Adaptive Card Try it Yourself \>] |
